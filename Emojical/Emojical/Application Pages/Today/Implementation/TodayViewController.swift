...
class TodayViewController: UIViewController {
    ...
    @IBOutlet var dayViews: [DayColumnView]!
    ...
    private func configureViews() {
        guard let firstDayView = dayViews.first else { return }
        ...
        for day in dayViews {
            day.stickerSize = floor(firstDayView.bounds.width)
        }
